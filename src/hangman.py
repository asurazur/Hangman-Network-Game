    ...
    def draw(condition, surface):
        for i in range(condition+1):
            if i == 0:
                ...
                pygame.draw.line(surface, GREY, (50,50),(50,400),8)#stick1
                pygame.draw.line(surface, GREY, (50,60),(250,60),8)#stick2
                pygame.draw.line(surface, GREY, (150,60),(150,100),8)#rope
                pygame.draw.circle(surface, GREY, (150,150),50,8)#head
                pygame.draw.line(surface, GREY, (150,200),(150,300),8)#body
                pygame.draw.line(surface, GREY, (150,210),(100,250),8)#lefthand
                pygame.draw.line(surface, GREY, (150,210),(200,250),8)#righthand
                pygame.draw.line(surface, GREY, (150,300),(100,350),8)#leftleg
                pygame.draw.line(surface, GREY, (150,300),(200,350),8)#rightleg

            elif i == 1:
                pygame.draw.line(surface, BLACK, (10,400),(300,400),8)#baseline

            elif i == 2:
                pygame.draw.line(surface, BLACK, (50,50),(50,400),8)#stick1

            elif i == 3:
                pygame.draw.line(surface, BLACK, (50,60),(250,60),8)#stick2

            elif i == 4:
                pygame.draw.line(surface, BLACK, (150,60),(150,100),8)#rope

            elif i == 5:
                pygame.draw.circle(surface, BLACK, (150,150),50,8)#head

            elif i == 6:
                pygame.draw.line(surface, BLACK, (150,200),(150,300),8)#body

            elif i == 7:
                pygame.draw.line(surface, BLACK, (150,210),(100,250),8)#lefthand

            elif i == 8:
                pygame.draw.line(surface, BLACK, (150,210),(200,250),8)#righthand

            elif i == 9:
                pygame.draw.line(surface, BLACK, (150,300),(100,350),8)#leftleg
